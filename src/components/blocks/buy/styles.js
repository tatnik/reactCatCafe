...
import buyBG from "../../../assets/buy-bg.svg"
import buyBGRight from "../../../assets/buy-right-bg.svg"
import buyBGRightTop from "../../../assets/buy-right-bg-top.svg"
...
export const StyledSection = styled(Section)`
  ...
  &::before {
    ...
    height: 468px;
    content: "";
    background-image: url(${buyBGRight});
  ...
  &::after {
    ...
    height: 409px;
    content: "";
    background-image: url(${buyBGRightTop});
    background-size: contain;
    background-repeat: no-repeat;
  }
`;
